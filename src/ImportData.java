...
public class ImportData {
	...
	*/
	 ...
	 */
	public void PrintData(Essay[] essays) {
		for (int i=0; i<essays.length; i++) {
			System.out.println("\nEssay #" + (i+1) + ": ");
			System.out.println(essays[i].getEssay());
		}
	}
	 ...
	 */
	public static float[][] ImportScores(String filename,int N_files) {
		int scoreColumns = 10; // identifier, 7 subparts, actual final score, and computed final score
		
		float[][] scores = new float[N_files][scoreColumns];
